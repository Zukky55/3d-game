            ...
            switch (dir)
            {
                ...
                case Direction.None:
                    ...
                    if (!m_isGoalSet)
                    {
                        ...
                        var goalPortal = GameObject.FindGameObjectWithTag("Portal");
                        goalPortal.transform.SetParent(transform);
                        goalPortal.transform.localPosition = new Vector3(pos.x, pos.y, pos.z);
                        goalPortal.transform.localScale = startCell.transform.localScale;
                    }
